	...
	function initAnimatePath(board){
		...
		switch(board.attr("id")){
			case "box_2":
				...
				moveToo($("#box_2"),$("#p2"),750,550,0.7,0.9);
				break;
			case "box_3":
				moveToo($("#box_3"),$("#p3"),-220,228,0.2,0.8);
				moveToo($("#box_3"),$("#p4"),-220,228,0.2,0.8);
				moveToo($("#box_3"),$("#p5"),-220,228,0.2,0.8);
				moveToo($("#box_3"),$("#p6"),850,501,0.7,0.9);
				moveToo($("#box_3"),$("#p7"),850,501,0.7,0.9);
				moveToo($("#box_3"),$("#p8"),850,501,0.7,0.9);
				break;
			case "box_4":
				moveToo($("#box_4"),$("#p9"),-200,259,0.2,0.8);
				moveToo($("#box_4"),$("#p10"),750,259,0.6,0.9);
				break;
			case "box_5":
				moveToo($("#box_5"),$("#p11"),-380,270,0.2,0.8);
				moveToo($("#box_5"),$("#p12"),850,506,0.7,0.9);
				break;
			default:
